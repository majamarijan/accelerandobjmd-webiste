...
<div className='figureBox'>
	<figure>
		...
		/>
		<figcaption>
			**Zdjęcie 5.** J.S.Bach, Badinerie z II suity orkiestrowej h –moll. (Autor: Przemysław Gabryel)
		</figcaption>
	</figure>
</div>
...
<div className='figureBox'>
	<figure>
		...
		/>
		<figcaption>
			**Zdjęcie 9.** K. Olczak, Trio hommage á Karol Szymanowski. (Autor: Piotr Rodak)
		</figcaption>
	</figure>
</div>
...
<div className='figureBox'>
	<figure>
		...
		/>
		<figcaption>
			**Zdjęcie 11.** H. H. Jabłoński, Capriccio no 1 for cello solo. (Autor: Sylwia Holeksa-Wilkowska)
		</figcaption>
	</figure>
</div>
...
<div className='figureBox'>
	<figure>
		...
		/>
		<figcaption>
			**Zdjęcie 12.** H. H. Jabłoński, Capriccio no 1 for cello solo. (Autor: Sylwia Holeksa-Wilkowska)
		</figcaption>
	</figure>
</div>
...
<div className='figureBox'>
	<figure>
		...
		/>
		<figcaption>
			**Zdjęcie 13.** P. Mykietyn, "Whoever hath her wish, thou hast thy will" to the words of Shakespeare's  Sonnet. (Autor: Krzysztof Warzała)
		</figcaption>
	</figure>
</div>
