---
title: 'The Musical Style of Elliott Carter: the analysis of the Piano Sonata (1945-1946)'
...
# The Musical Style of Elliott Carter: the analysis of the Piano Sonata (1945-1946)
...
<strong>Citation:</strong> Wang, Yingying. 2020. "The Musical Style of Elliott Carter The analysis of the Piano Sonata (1945-1946)." [_Accelerando: Belgrade Journal of Music and Dance 5:2_](http://localhost:3000/articles/issue8/art)
...
<div className='figureBox'>
	<figure className='score'>
		...
		/>
		<figcaption>
			**_Example 1.1._** Prokofiev, Piano Concerto No. 3, First movement, mm.
			15-20.{' '}
		</figcaption>
	</figure>
</div>
...
<table>
	...
	<tbody>
		<tr>
			<td>
				(0 4 8) <br /> (0 2 7) <br /> (0 1 5 ) <br /> (0 3 7)
			</td>
			<td>
				(0 1 4 6) <br /> (0 1 3 7 ) <br /> (0 2 6 8 )
			</td>
			<td>
				(0 2 4 9 7) <br /> (0 1 4 5 8) <br /> (0 2 3 6 8 ) <br /> (0 1 2 4 7)
			</td>
			<td>
				(0 1 3 5 6 9) <br /> (0 2 4 6 8 10) <br /> (0 1 2 3 6 9) <br /> (0 2 3 4
				5 8)
			</td>
		</tr>
	</tbody>
...
<div className='figureBox'>
	<figure className='score'>
		...
		/>
		<figcaption>
			**_Example 2.9._** Tonal pitches C – Ab emphasize keys of A# and B, mm.
			83-93.
		</figcaption>
	</figure>
</div>
...
<div className='figureBox'>
	<figure className='score'>
		...
		/>
		<figcaption>**_Example 2.10._** mm. 60- 64, mm. 77-79</figcaption>
	</figure>
</div>
...
<div className='figureGrid'>
	<div className='figureBox'>
		<figure className='score'>
			...
			/>
			<figcaption>**_Example 2.11._** mm. 65 - 70</figcaption>
		</figure>
	</div>
	<div className='figureBox'>
		<figure className='score'>
...
<div className='figureBox'>
	<figure className='score'>
		...
		/>
		<figcaption>
			**_Example 2.13._** B major chord at the end of the Exposition recalling
			the (i) motive, mm. 116-125.
		</figcaption>
	</figure>
</div>
...
<div className='figureBox'>
	<figure className='score'>
		...
		/>
		<figcaption>
			**_Example 2.14._** C-octave reappears in the second half of the secondary
			theme, G-C octaves implicating "V-I" "emphatic cadence", mm.100-104.
		</figcaption>
	</figure>
</div>
...
<div className='figureBox'>
	<figure className='score'>
		...
		/>
		<figcaption>
			**_Example 2.15._** (i) and its inversions function as cadence materials
			close up exposition, mm. 108 – 11
		</figcaption>
	</figure>
</div>
...
<div className='figureBox'>
	<figure className='score'>
		...
		/>
		<figcaption>
			**_Example 2.16._** Opening chordal melody in D Major expands over
			ostinato in B section in Db Major, mm. 1-6, mm. 33-36.
		</figcaption>
	</figure>
</div>
...
<div className='figureBox'>
	<figure className='score'>
		...
		/>
		<figcaption>
			**_Example 2.17._** Long-range linear progression in the bass line, mm.
			33-56.
		</figcaption>
	</figure>
</div>
...
<div className='figureBox'>
	<figure className='score'>
		...
		/>
		<figcaption>
			**_Example 2.18._** Dyad in D Major in transition to Misterioso
			anticipates Db Major
		</figcaption>
	</figure>
</div>
...
<div className='figureBox'>
	<figcaption>**_Table 2.2._** Structure of Fugue</figcaption>
	<figure>
		<img
...
<div className='figureBox'>
	<figure className='score'>
		...
		/>
		<figcaption>
			**_Example 2.24._** Reverse exposition, voices move simultaneously, mm.
			272 – 275.
		</figcaption>
	</figure>
</div>
...
<div className='figureBox'>
	<figure className='score'>
		...
		/>
		<figcaption>
			**_Example 2.27._** Climax of the cantilena, lowest Bb to the highest B,
			mm. 358-361.
		</figcaption>
	</figure>
</div>
...
The epilogue (mm. 393-414) fuses the main thematic ideas from both movements and brings an end to the sonata. The motivic material of the epilogue is derived from (a), (d) and (e). Before landing on B, the final resolution brings into focus the juxtaposition of the keys of B and Bb for the last time. The final chord contains three B octaves and the full F# chord in the key of A# (_Example 2.28)_, followed by the strong reiteration of the D#-F# dyad, recalling the third at m. 361 (_Example 2.27_).

<div className='figureBox'>
	<figure className='score'>
		<img
			src={require('@site/issue5/article02/ex2-28.png').default}
			alt='Example 2.28. Last chord ends on B, superimposed with A# key, mm. 404-414.'
		/>
		<figcaption>
			**_Example 2.28._** Last chord ends on B, superimposed with A# key, mm.
			404-414.
		</figcaption>
	</figure>
</div>
...
1. Bernard, Jonathan W. 2003. _Elliott Carter: Collected Essays and Lectures, 1937-1995_. University of Rochester Press.
2. Boulez, Pierre. 1991. Translated by Stephen Walsh as _Stocktakings from an Apprenticeship_. Oxford: Clarendon.
3. Carter, Elliott. 1982. _Piano Sonata (1945-46)_. New York: Mercury Music.
4. Carter, Elliot and Enzo Restagno. 1991. "Elliott Carter: In _Conversation with Enzo Restagno for Settembre Musica 1989_." Translated by Katherine Silberblatt Wolfthal. New York: Brooklyn College of the City University of New York.
...
6. Kostelanetz, Richard. 2013. _A Dictionary of the Avant-Gardes_. London and New York: Routledge.
7. Link, John. 1994. "Long-Range Polyrhythms in Elliott Carter’s Recent Music." PhD. diss. City University of New York.
8. Meyer, Felix, and Anne C. Shreffler. 2008. _Elliott Carter: A Centennial Portrait in Letters and Documents_. Suffolk: The Boydell Press Woodbridge.
...
10. Rosen, Charles. 1984. _The Musical Languages of Elliott Carter_. Washington, D. C.: Library of Congress.
11. Schiff, David. 1998. _The Music of Elliott Carter_. New York: Cornell University Press.
12. Slonimsky, Nicolas. 1938. _Music since 1900. 2nd edition_. New York: W. W. Norton.
