---
title: 'An Empirical Research: Indian Classical Dance Education And its Impact on The Students Spiritual Intelligence'
...
<div className='figureBox'>
<table>
<caption>Table 1. Gender - frequency analysys</caption>
	<thead>
		<tr>
			<th></th>
			<th></th>
...
<table>
	<caption>Table 2. Reliability analysis with Cronbach-Alpha test</caption>
	<thead>
		<tr>
			<th>S.No</th>
			<th>Construct</th>
...
<div className='figureBox'>
	<figure>
		<figcaption>**_Table 3a._** Model Summary</figcaption>
		<img
			src={require('@site/issue7/article04/kanaka-table3a.png').default}
			alt='Table 3a. Model Summary'
		/>
	</figure>
	<span>a. Predictors: (Constant), YPB</span>
</div>

<div className='figureBox'>
	<figure>
		<figcaption>**_Table 3b._** ANOVAa</figcaption>
		<img
			src={require('@site/issue7/article04/kanaka-table3b.png').default}
			alt='Table 3b. ANOVAa'
		/>
	</figure>
	<span>a. Dependent Variable: SICET</span>
	<span>b. Predictors: (Constant), YPB</span>
</div>
...
<div className='figureBox'>
	<figure>
		<figcaption>
			**_Table 3c._** Coefficients<sup>a</sup>
		</figcaption>
		<img
			src={require('@site/issue7/article04/kanaka-table3c.png').default}
			alt='Table 3c. Coefficients'
		/>
	</figure>
	<span>a. Dependent Variable: SICET</span>
</div>
...
<div className='figureBox'>
	<figure>
		<figcaption>**_Table 4a._** Model Summary</figcaption>
		<img
			src={require('@site/issue7/article04/kanaka-table4a.png').default}
			alt='Table 4a. Model Summary'
		/>
	</figure>
	<span>a. Predictors: (Constant), YPB</span>
</div>
...
<div className='figureBox'>
	<figure>
		<figcaption>
			**_Table 4b._** Coefficients<sup>a</sup>
		</figcaption>
		<img
			src={require('@site/issue7/article04/kanaka-table4b.png').default}
			alt='Table 4b. Coefficients'
		/>
	</figure>
	<span>a. Dependent Variable: SIPMP</span>
	<span>b. Predictors: (Constant), YPB</span>
</div>
...
<div className='figureBox'>
	<figure>
		<figcaption>
			**_Table 4c._** Coefficients<sup>a</sup>
		</figcaption>
		<img
			src={require('@site/issue7/article04/kanaka-table4c.png').default}
			alt='Table 4c. Coefficients'
		/>
	</figure>
	<span>a. Dependent Variable: SIPMP</span>
</div>
...
<div className='figureBox'>
	<figure>
		<figcaption>**_Table 5a._** Model Summary</figcaption>
		<img
			src={require('@site/issue7/article04/kanaka-table5a.png').default}
			alt='Table 5a. Model Summary'
		/>
	</figure>
	<span>a. Predictors: (Constant), YPB</span>
</div>
...
<div className='figureBox'>
	<figure>
		<figcaption>
			**_Table 5b._** ANOVA<sup>a</sup>
		</figcaption>
		<img
			src={require('@site/issue7/article04/kanaka-table5b.png').default}
			alt='Table 5b. ANOVA'
		/>
	</figure>
	<span>a. Dependent Variable: SICET</span>
...
<div className='figureBox'>
	<figure>
		<figcaption>
			**_Table 5c._** Coefficients<sup>a</sup>
		</figcaption>
		<img
			src={require('@site/issue7/article04/kanaka-table5c.png').default}
			alt='Table 5c. Coefficients'
		/>
	</figure>
	<span>a. Dependent Variable: SITA</span>
</div>
...
<div className='figureBox'>
	<figure>
		<figcaption>**_Table 6a._** Model Summary</figcaption>
		<img
			src={require('@site/issue7/article04/kanaka-table6a.png').default}
			alt='Table 6a. Model Summary'
		/>
	</figure>
	<span>a. Predictors: (Constant), YPB</span>
</div>
...
<div className='figureBox'>
	<figure>
		<figcaption>
			**_Table 6b._** ANOVA<sup>a</sup>
		</figcaption>
		<img
			src={require('@site/issue7/article04/kanaka-table6b.png').default}
			alt='Table 6b. ANOVA'
		/>
	</figure>
	<span>a. Dependent Variable: SITA</span>
...
<div className='figureBox'>
	<figure>
		<figcaption>
			**_Table 6c._** Coefficients<sup>a</sup>
		</figcaption>
		<img
			src={require('@site/issue7/article04/kanaka-table6c.png').default}
			alt='Table 6c. Coefficients'
		/>
	</figure>
	<span>a. Dependent Variable: SICSE</span>
</div>
...
<div className='figureBox'>
	<figure>
		...
		<img
			src={require('@site/issue7/article04/kanaka-table7.png').default}
			alt='Table 7. Hayes process for gender as moderator'
		/>
	</figure>
	<span></span>
</div>
...
<div className='figureBox'>
	<figure>
		<figcaption>
			**_Table 8._** Hypothesis-testing outcomes

    	</figcaption>
    	<img
    		src={require('@site/issue7/article04/kanaka-table8.png').default}
    		alt='Table 8. Hypothesis-testing outcomes'
    	/>
    </figure>
