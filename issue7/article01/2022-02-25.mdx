---
title: '#1 Anatomy Of Ethos, Pathos In Music Of Africa ​and Its Pathogenic Essence'
...
# #1 Anatomy Of Ethos, Pathos In Music Of Africa ​and Its Pathogenic Essence
...
<table className='centerText'>
	...
	<tbody>
		...
		<tr>
			<td rowSpan={2}>Average Musical Instruments Acoustics Volume</td>
			<td>
		...
		<tr>
			<td style={{textAlign:'center'}}>108.25 dB</td>
			<td>107 dB</td>
			<td>105 dB</td>
			<td>109 dB</td>
			<td>Very high</td>
		...
		<tr>
			<td rowSpan={2}>Average of Noise Level in All the Selected Church Auditoria</td>
			<td>
